...
const addValues = (arr) => {
  let newArr = arr.reduce((runningTotal, currentValue) => {
...
const addPurchases = (arr) => {
  let newArr = arr.reduce((runningValue, currentValue) => {
    return runningValue + currentValue.purchasePrice;
  }, 0);
  return newArr;
};
...
const countNumberOfElements = (arr) => {
  let newArr = arr.reduce((runningSum, currentValue) => {
    currentValue = 1;
...
const returnNames = (arr) => {
  let newArr = arr.reduce((newNameArray, obj)=> {
    newNameArray.push(obj.name);
    return newNameArray;
  }, []);
  return newArr;
};
...
const reversedString = (str) => {
  ...
  let newStr = stringToArray.reduce((accum, char) => {
    return char + accum;
  },'');
  return newStr;
};
